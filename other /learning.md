...
im abandoning the cropping idea becuase defining a centroid that isnt sqirelly to then define the center of the frame is tough, and i dont even think it would look that good. opting for slo-mo and some software to directly shift it into an edit, ideally with some audio overlayed.
...
-dont just pip install things, you need to install to the specific enviornment (base or venv)
